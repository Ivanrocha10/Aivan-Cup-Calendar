...
document.querySelector('#cards').innerHTML = 
  ...
  createCard('29/11', 'terça', createGame('ecuador', '07:00', 'senegal') + createGame('netherlands', '12:00', 'qatar') + createGame('iran', '16:00', 'united states') + createGame('wales', '16:00', 'england')) +
